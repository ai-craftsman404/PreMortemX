...
4. Create a run directory with `scripts/New-PreMortemXRun.ps1`.
...
9. Update the local registry with `scripts/Update-PreMortemXRegistry.ps1`.
10. Validate the run record with `scripts/Test-PreMortemXRunRecord.ps1`.
